...
import com.main.icusensor.events.GrblAlarmEvent;
import com.main.icusensor.events.GrblOkEvent;
import com.main.icusensor.events.GrblProbeEvent;
import com.main.icusensor.events.UiToastEvent;
import com.main.icusensor.model.Constants;
import com.main.icusensor.model.Position;
import com.main.icusensor.util.GrblLookups;
...
//            EventBus.getDefault().post(new ConsoleMessageEvent(settingMessageEvent.toString()));
            ...
            if (buildInfo.versionDouble >= Constants.MIN_SUPPORTED_VERSION) {
                ...
                //String messageNotSupported = getInstance().getString(R.string.text_grbl_unsupported, String.valueOf(Constants.MIN_SUPPORTED_VERSION));
